...
if (isset($_POST['tambah'])) {
    ...
    // Pertama, kita akan menghitung total harga paket dari tb_paket berdasarkan id_paket
    $total_harga_paket = 0;
...
$query = "INSERT INTO tb_transaksi (id_outlet, kode_invoice, id_member, tgl, batas_waktu, tgl_bayar, biaya_tambahan, diskon, pajak, status, dibayar, id_user, total_harga) VALUES ('$id_outlet', '$kode_invoice', '$id_member', '$tgl', '$batas_waktu', '$tgl_bayar', '$biaya_tambahan', '$diskon', '$pajak', '$status', '$dibayar', '$id_user', '$total_harga')";
...
if ($result) {
    ...
    // Menambahkan detail transaksi ke tb_detail_transaksi tanpa keterangan
    $query_detail = "INSERT INTO tb_detail_transaksi (id_transaksi, id_paket, qty) VALUES ('$id_transaksi', '$id_paket', '$qty');"; // hapus keterangan
